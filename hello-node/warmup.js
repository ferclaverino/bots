...
board.on("ready", function() {
    ...
    var repeat = function() {
      temporal.queue([
        { delay: 500, task: function() { servo1.to(60); } },
        { delay: 500, task: function() { servo2.to(60); } },
        { delay: 500, task: function() { servo3.to(60); } },
        { delay: 500, task: function() { servo1.to(20); } },
        { delay: 500, task: function() { servo2.to(20); } },
        { delay: 500, task: function() { servo3.to(20); } },
      ]);
    };
